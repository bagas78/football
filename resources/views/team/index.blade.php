                            ...
                            <div class="modal-body">
                              <form method="post" action="{{ url('team/update') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="penanggung" class="form-control" required="" placeholder="Penanggung Jawab" value="{{ $key->team_penanggung }}">
                                </div>
                                <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{ url('team/insert') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label>Penanggung Jawab</label>
            <input type="text" name="penanggung" class="form-control" required="" placeholder="Penanggung Jawab" value="">
          </div>
          <div class="form-group">
            <label for="exampleInputFile">Logo</label><small>(jpg, png, gif)</small>
            <div class="input-group">
